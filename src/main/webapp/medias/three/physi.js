window.Physijs = (function () {
    ...
    Physijs.Scene = function (params) {
        ...
        this._worker = new Worker(Physijs.scripts.worker || '../medias/three/physijs_worker.js');
    ...
    Physijs.Scene.prototype._updateCollisions = function (data) {
        ...
        var i, j, offset, object, object2, id1, id2,
            collisions = {}, normal_offsets = {},impulse;
        ...
        for (i = 0; i < data[1]; i++) {
            ...
            impactPoint.set(data[offset + 5], data[offset + 6], data[offset + 7]);
            impulse=data[offset + 8];
                ...
                for (j = 0; j < collisions[id1].length; j++) {
                    ...
                    if (object2) {
                        ...
                        if (object._physijs.touches.indexOf(id2) === -1) {
                            ...
                            object.dispatchEvent('collision', object2, _temp1, _temp2, _temp_vector3_1,impactPoint,impulse);
                        }
                    }
                }
